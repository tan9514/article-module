...
{
    public $tableName = "article_favorite";
    ...
    private function create()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('uid')->nullable(false)->comment("用户ID")->index("uid_index");
        ...
        $qu = "ALTER TABLE " . $prefix . $this->tableName . " comment '文章收藏关联表'";
        DB::statement($qu);
    }
}
