...
class CreateArticleAttrTable extends Migration
{
    ...
    private function create()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->id();
            $table->string("name")->nullable(false)->comment("属性名称")->unique("name_index");
            $table->timestamps();
        });
        $prefix = DB::getConfig('prefix');
        $qu = "ALTER TABLE " . $prefix . $this->tableName . " comment '文章属性表'";
        DB::statement($qu);
    }
}
