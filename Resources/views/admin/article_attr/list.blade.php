...
@section('listscript')
    <script type="text/javascript">
        layui.use(['form','table','laydate'], function(){
            ...
            table.render({
                elem: '#tableList',
                url:'/admin/article_attr/ajaxList',
                ...
                switch(obj.event){
                    case "add": // 新增
                        var index = layer.open({
                            ...
                            shadeClose: true,
                            area: ['80%', '80%'],
                            content: '/admin/article_attr/edit',
                            end:function() {
                ...
                switch (obj.event){
                    case "edit":  // 编辑功能
                        var index = layer.open({
                            ...
                            shadeClose: true,
                            area: ['80%', '80%'],
                            content: '/admin/article_attr/edit?id='+id,
                            end:function(res) {
                                table.reload('listReload');
                            }
                        });
                        break;
                    case "del":  // 删除功能
                        layer.confirm('确定删除 ' + data.name + ' 属性吗？', {
                            title : "删除属性",
                            skin: 'layui-layer-lan'
                        },function(index){
                            $.ajax({
